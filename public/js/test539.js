...
$(function() {
  ...
  let filterArr = loto539.filter(obj => obj["summary"])
  ...
  let reduceObj = summaryArr.reduce((sumObj, arr) => {
    ...
    arr.forEach(obj => {
      ...
      let ttlcnt = sumObj[obj.num]["1.count"]
      ...
      if (sumObj[obj.num]['2.diff'][obj.diff]["count"]) {
        ...
        //testing
        let cnt = sumObj[obj.num]['2.diff'][obj.diff]["count"]
        let pcnt = cnt/ttlcnt
        sumObj[obj.num]['2.diff'][obj.diff]["pcnt"] = pcnt
        //
      } else {
        sumObj[obj.num]['2.diff'][obj.diff]["count"] = 1
        sumObj[obj.num]['2.diff'][obj.diff]["pcnt"] = 1/ttlcnt
      }
      ...
      if (sumObj[obj.num]['3.mindiff'][obj.mindiff]["count"]) {
        ...
        //
        let cnt = sumObj[obj.num]['3.mindiff'][obj.mindiff]["count"]
        let pcnt = cnt/ttlcnt
        sumObj[obj.num]['3.mindiff'][obj.mindiff]["pcnt"] = pcnt
        //
      } else {
        sumObj[obj.num]['3.mindiff'][obj.mindiff]["count"] = 1
        sumObj[obj.num]['3.mindiff'][obj.mindiff]["pcnt"] = 1/ttlcnt
      }
      ...
      if (sumObj[obj.num]['4.maxdiff'][obj.maxdiff]["count"]) {
        ...
        //
        let cnt = sumObj[obj.num]['4.maxdiff'][obj.maxdiff]["count"]
        let pcnt = cnt/ttlcnt
        sumObj[obj.num]['4.maxdiff'][obj.maxdiff]["pcnt"] = pcnt
        //
      } else {
        sumObj[obj.num]['4.maxdiff'][obj.maxdiff]["count"] = 1
        sumObj[obj.num]['4.maxdiff'][obj.maxdiff]["pcnt"] = 1/ttlcnt
      }
      ...
      if (sumObj[obj.num]['5.intv'][obj.intv]["count"]) {
        ...
        //
        let cnt = sumObj[obj.num]['5.intv'][obj.intv]["count"]
        let pcnt = cnt/ttlcnt
        sumObj[obj.num]['5.intv'][obj.intv]["pcnt"] = pcnt
        //
      } else {
        sumObj[obj.num]['5.intv'][obj.intv]["count"] = 1
        sumObj[obj.num]['5.intv'][obj.intv]["pcnt"] = 1/ttlcnt
      }
  ...
  //console.log("reduceObj", reduceObj)
   console.log("reduceObj:",JSON.stringify(reduceObj,null,2))
...
function getReport(dateperiod,totalrecord, reduceObj) {
    ...
    $("<h4>").text("今彩539統計分析").css({textAlign: "center",fontWeight:"bold",color:"blue"})
    .appendTo('body')
