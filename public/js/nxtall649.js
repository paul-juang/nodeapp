...
$(function() {
  ...
  allDate.forEach(date0 => {
    ...
    if (prelotonum.length != 0  ) {
      let arrOnChange = loto649.filter(obj => obj["date"] <= date0)
      ...
      temp['bonus'] = prebonus
      temp['summary'] = prenum649[0].summary
      num649.push(temp)
    }
   })
   //console.log("num649", num649)
   //num649 = num649.filter(obj => obj.summary.length === 49)
   num649.forEach(obj => {
