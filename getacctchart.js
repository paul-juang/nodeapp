//copy from agetacctchart but not working
//something wrong with acctchart.txt???
const fs = require('fs');
const async = require("async");
 async.waterfall([
    function(callback) {
      ...
      fs.writeFile('acctchart0.json', json, 'utf8', function(err,result){ 
        if(err) {
          console.log("write acctchart0.json error");
        }else {}
        console.log("write acctchart0.json success!")
      }); 
    ...
    function(arg1,callback) {
          ...
          fs.writeFile('acctclass0.json', json, 'utf8', function(err,result){ 
            if(err) {
              console.log("write acctclass0.json error!");
            }else {
              console.log("write acctclass0.json success!");
            }
          })   
